...
<head>
  ...
  <title><?php echo $this->config->item('fogata_backend_title'); ?></title>
  <base href="<?=base_url();?>">
...
<body class="fogata-container hold-transition <?php echo $this->config->item('fogata_backend_skin'); ?> <?php echo $this->config->item('fogata_layout'); ?>">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>dashboard" class="logo">
      ...
      <span class="logo-lg">
        <?php echo $this->config->item('logo_lg'); ?>
      </span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      <?php echo $this->config->item('cr_right'); ?>
    </div>
    <!-- Default to the left -->
    <?php echo $this->config->item('cr_left'); ?>
  </footer>
